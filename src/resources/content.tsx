...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
        สวัสดีครับ ผมชื่อ จิตติพัฒน์ ส้มสาย ชื่อเล่นของผมคือ แบทแมน อายุ 17 ขณะนี้กําลังศึกษาอยู่ในระดับชั้นมัธยมศึกษาปีที่ 5 โรงเรียนบุญวัฒนา 
        เป็นคนที่ชื่นชอบในการสร้าง Web / Front End โดยใช้ Next.JS / Nuxt / Vue และชอบเล่นดนตรีเป็นงานอดิเรก โดยเฉพาะการเล่นกลองครับ
      </>
    ),
  },
  work: {
